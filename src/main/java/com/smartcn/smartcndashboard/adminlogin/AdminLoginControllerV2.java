...
//public class AdminLoginControllerV2 implements RequestHandler<AdminLoginModel, Object> {
//
//  @Value("${jwt.secret}")
...
//
//  public AdminLoginControllerV2(AdminLoginService adminLoginService) {
//    super();
...
//  public ResponseEntity<StatusResponse> saveFieldschart(
//      @RequestBody DashBoardModelChart dashBoardModel) {
//    StatusResponse statusMessage = new StatusResponse();
//
//    try {
//
...
//  public ResponseEntity<StatusResponse> forgetPassword(
...
//  public ResponseEntity<StatusResponse> forgetPasswordUpdate(
//      @RequestBody AdminLoginModel adminLoginModel, @RequestHeader("x-access-token") String token) {
//    StatusResponse statusMessage = new StatusResponse();
//
//    try {
...
//
//  // @PostMapping("/forgetPassword")
//  // public ResponseEntity<StatusResponse> resetPassword(@RequestBody AdminLoginModel
//  // adminLoginModel) {
...
//  // String email = adminLoginModel.getEmail();
//  // String encryptedPassword = Masking.encrypt(password, maskSecretKey);
//  // AdminLoginModel adminLoginModelResponse = adminLoginService.getByEmail(email);
...
//    JwtBuilder builder =
//        Jwts.builder().setId(email).setIssuedAt(now).setIssuer(redirectUrl)
...
//    // Let's set the JWT Claims
//    JwtBuilder builder =
//        Jwts.builder().setId(email).setIssuedAt(now).signWith(signatureAlgorithm, signingKey)
