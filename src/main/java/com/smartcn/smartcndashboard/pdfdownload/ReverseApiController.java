...
@Transactional
@RestController
@RequestMapping(path = "/v1/reverseapi")
public class ReverseApiController {

	@Autowired
	ReverseApiService ReverseApiService;

	public ReverseApiController(ReverseApiService reverseApiService) {
		super();
		ReverseApiService = reverseApiService;
	}
...
//				break;
			...
			case "commcn":
				pdfBucketName = "common-cn-pdf-file";
				dName = "d1qy0npuu348ub.cloudfront.net";
				folderName = "contractNote/";
				break;
...
//				
//			case "dmr":
//				pdfBucketName = "mosl-dmr-cn-pdf-file";
//				dName = "d2dbgwpo1k3qji.cloudfront.net";
//				folderName = "contractNote/";
//				break;
