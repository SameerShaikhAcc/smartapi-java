...
//@DynamoDBTable(tableName = "smartcn_smartcontract_note")
@DynamoDBTable(tableName = "smartcn_smartcontract_note")
...
public class DashBoardModel {
	...
	public String toString() {
		return "DashBoardModel [processId=" + processId + ", fileName=" + fileName + ", segmentName=" + segmentName
				+ ", processStatus=" + processStatus + ", activityDate=" + activityDate + ", yearSearched="
				...
				+ startTime + ", endTime=" + endTime + ", totalProcessTime=" + totalProcessTime + "]";
	}
}